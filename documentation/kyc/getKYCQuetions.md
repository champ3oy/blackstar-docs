...
```bash
curl -X GET "https://api.uatdev.blackstargroup.ai/api/kyc/3fa85f64-5717-4562-b3fc-2c963f66afa6/get-kyc" \
...
const url = `https://api.uatdev.blackstargroup.ai/api/kyc/${clientSubTypeId}/get-kyc`;
